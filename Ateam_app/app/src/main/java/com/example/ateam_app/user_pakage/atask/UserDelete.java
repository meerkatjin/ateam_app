...
public class UserDelete extends AsyncTask<Void, Void, String> {

    private UserDTO dto;

    public UserDelete(UserDTO dto){
        this.dto = dto;
    }

    // 데이터베이스에 삭제결과 0보다크면 삭제성공, 같거나 작으면 실패
    String state = "";
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            Log.d("탈퇴", "doInBackground: " + dto.getUser_id());

            String postURL = ipConfig + "/ateamappspring/appUserDelete";
            // 전송
